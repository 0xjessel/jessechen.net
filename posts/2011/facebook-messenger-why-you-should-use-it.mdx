...
Today, Facebook announced a new standalone-app called [Facebook Messenger](https://www.facebook.com/mobile/messenger).  Tech-savvy users might have heard of WhatsApp or Beluga (which was bought by Facebook to create Facebook Messenger), which are mobile messaging apps that Facebook Messenger *will* eventually replace.  This app is killer because it essentially replaces SMS and all other forms of mobile communication.
